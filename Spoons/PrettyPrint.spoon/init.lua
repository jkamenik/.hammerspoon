--- === PrettyPrint ===
---
--- Provides a function "print" to pretty print any object
---
--- Idea stolen from https://github.com/Anaminus/lua-pretty-print
---

local obj = {}

-- Metadata
obj.name = "PrettyPrint"
obj.version = "1.0"
obj.author = "John Kamenik <jkamenik@gmail.com>"
...
--- PrettyPrint:stringify(table)
--- Method
--- Converts a Table to a string in a human readable way.
---
--- Parameters:
---  * table - A table to be printed
function obj:stringify(t)
    if t == nil then
    ...
    print(t)
    -- Kick recurse the table
    return traverseTable(table, {[table]=true}, 0)
end

--- PrettyPrint:alert(table)
--- Method
--- A basic alert of the table
---
--- Parameters:
---  * table - A table to alert
function obj:alert(table)
    hs.alert.show(obj:stringify(table))
end
